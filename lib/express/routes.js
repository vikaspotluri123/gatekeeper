const {auth, home, apiV1} = require('../controllers/index.js');
const config = require('../config.js');
const {noAccess, notFound} = require('../utils/index.js').jsonResponse;

module.exports.init = function route(app) {
	const {requireLogin, requireLogout, session, securityHeaders} = require('./middleware.js');
